        <table class="wp-list-table widefat fixed bookmarks">
                ...
                <tr>
                	<td>
                    	<ol>
                        	<li>Select the image size you want to keep in your rss feed.</li>
                            
                            <li>Click Save Changes</li>

							<li>You are done.</li>
                            
                            <li>If you still have any problem visit our <a href="http://dineshkarki.com.np/forums/forum/featured-image-in-rss" target="_blank">support forum</a> or you can write to us directly using our contact form.</li>
        ...
        <td width="250" valign="top">
            ...
            <table class="wp-list-table widefat fixed bookmarks">
                ...
                <tr>
                	<td>
                    <ol class="uaf_list">
                    	<li><a href="https://dineshkarki.com.np/forums/forum/featured-image-in-rss" target="_blank">View Support Forum</a></li>
            ...
            <table class="wp-list-table widefat fixed bookmarks">
                ...
                <tr>
                	<td>
                    	<ol class="uaf_list">
                        	<li><a target="_blank" href="https://wordpress.org/plugins/honeypot">WP Armour – Honeypot Anti Spam</a></li>
                            <li><a target="_blank" href="https://wordpress.org/plugins/use-any-font">Use Any Font</a></li>
                            <li><a target="_blank" href="https://wordpress.org/plugins/email-checker/">Deliverability Email Validation</a></li>
